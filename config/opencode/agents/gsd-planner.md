...
<execution_context>
@/home/ashleyst/.config/opencode/get-shit-done/workflows/execute-plan.md
@/home/ashleyst/.config/opencode/get-shit-done/templates/summary.md
</execution_context>
...
```bash
node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit "fix($PHASE): revise plans based on checker feedback" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md
```
...
```bash
INIT=$(node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init plan-phase "${PHASE}")
...
```bash
node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" history-digest
```
...
```bash
VALID=$(node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
```bash
node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
