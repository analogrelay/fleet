...
Reference full template: `/home/ashleyst/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ashleyst/.config/opencode/get-shit-done/templates/state.md`.
