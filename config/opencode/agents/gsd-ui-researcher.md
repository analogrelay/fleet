...
Use template from `/home/ashleyst/.config/opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/ashleyst/.config/opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/ashleyst/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
