...
let
  ...
  linuxUser = defaultConfig // {
    ...
    initialHashedPassword =
      "$y$j9T$q0Sl6jJo8lxrJkXt3p2yq0$c0rXC6qssKoj2GSPtmrgOnbwXOEcUe8qLxChOJrP0s.";
    extraGroups = [
      "wheel"
      "networkmanager"
      "libvirtd"
  ...
  darwinUser = defaultConfig // { home = "/Users/ashley"; };
in {
  ...
  home-manager.users.ashley = {
    imports = [ ../../home ] ++ lib.optional
      (builtins.pathExists ../../home/hosts/${config.networking.hostName}.nix)
